package apache.maven.org.selenium_project.selenium_project;
...
public class App 
{
    public static void main( String[] args )
    {
     //  System.out.println( "Hello World!" );
		...
		driver.findElement(By.id("gwt-uid-5")).sendKeys("TestNM"); 
		driver.findElement(By.id("gwt-uid-7")).sendKeys("manoj");
